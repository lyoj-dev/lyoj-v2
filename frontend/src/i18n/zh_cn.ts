...
export const zh_cn = {
    route: {
        ...
        adminTagsList: "标签管理",
        adminUsersList: "用户管理",
        adminUsersCreate: "创建用户",
        adminUserGroupsList: "用户组管理"
    },
    appbar: {
        index: "首页",
        problem: "题库",
        ...
        admin: {
            ...
            users: {
                ...
                list: {
                    ...
                    editButton: "编辑",
                    addUser: "创建用户",
                    selectedUser: "共选中 {count} 项，当前选中 {selected} 项",
                    addSelectedButton: "为选中用户添加用户组",
                    addUserGroupButton: "添加用户组",
                    removeSelectedButton: "为选中用户删除用户组",
                    removeUserGroupButton: "删除用户组",
                    deleteSelectedButton: "删除选中用户",
                    deleteButton: "删除",
                    showSelectedButton: "仅显示选中用户",
                    showAllButton: "显示全部用户",
                    addGroup: "添加用户组",
                    removeGroup: "删除用户组",
                    submit: "提交",
                    addGroupConfirm: "确定添加 {count} 个用户组吗？",
                    removeGroupConfirm: "确定删除 {count} 个用户组吗？",
                    noGroup: "用户组不能为空",
